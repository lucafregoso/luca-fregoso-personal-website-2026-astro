...
const it = {
  ...
  metrics: [
    { value: '15 anni', label: 'tra software e programmi tecnici' },
    { value: '300+ dev', label: 'ecosistema aziendale dietro una business unit academy' },
    { value: '7', label: 'edizioni Codemotion tra Milano, Madrid e Roma' },
    { value: '~600', label: 'proposte CFP valutate per edizione' },
    { value: 'MC', label: 'per eventi tech anche oltre Codemotion' },
  ],
  capabilities: [
  ...
  caseStudies: [
    { label: 'Programmi di conferenza', title: 'Costruire agende autorevoli in Europa', description: 'Coordino comitati internazionali e trasformo circa 600 proposte in programmi equilibrati per sette edizioni Codemotion: tre a Milano, due a Madrid e due a Roma.', outcome: '2.000–3.000 developer coinvolti in ogni evento', href: '#talks', linkLabel: 'Scopri i talk' },
    ...
    { label: 'Programmi di formazione', title: 'Creare un’academy tecnica da zero', description: 'Ho guidato programma, modello didattico e ritmo operativo di una business unit academy dentro un ecosistema aziendale di oltre 300 developer.', outcome: '~200 persone formate per professioni tecniche', href: '/cv.pdf', linkLabel: 'Leggi il CV completo', download: true },
  ],
  work: {
